		...
		return (
			React.createElement("nav", {className: "row"}, 
				React.createElement("div", {className: "navBtn", id: "inbox"}, 
					React.createElement("img", {src: "images/google-inbox_2x.png", alt: "Inbox", height: "40", width: "90"})
				), 

				React.createElement("div", {className: "navBtn", id: "gmail"}, 
					React.createElement("img", {src: "images/New_Logo_Gmail.svg.png", alt: "Gmail", height: "40", width: "90"})
				)
			)
		)
	}
